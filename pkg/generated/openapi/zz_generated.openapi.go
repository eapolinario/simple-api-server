...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.Task":       schema_pkg_apis_tasks_v1alpha1_Task(ref),
		"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskList":   schema_pkg_apis_tasks_v1alpha1_TaskList(ref),
		"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskSpec":   schema_pkg_apis_tasks_v1alpha1_TaskSpec(ref),
		"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskStatus": schema_pkg_apis_tasks_v1alpha1_TaskStatus(ref),
...
func schema_pkg_apis_tasks_v1alpha1_Task(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Task is a unit of asynchronous work scheduled through this aggregated APIServer.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec is the user-supplied desired state.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status is the observed state. Only writable via the /status subresource.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskSpec", "github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.TaskStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_tasks_v1alpha1_TaskList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TaskList is a list of Task objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.Task"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/eapolinario/simple-api-server/pkg/apis/tasks/v1alpha1.Task", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_tasks_v1alpha1_TaskSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TaskSpec is the user-facing intent for a Task.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "Image is the container image to run. Required.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"command": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Command optionally overrides the image entrypoint.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"args": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Args optionally overrides the image command arguments.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_tasks_v1alpha1_TaskStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TaskStatus reports the observed state of a Task. Only mutable via the /status subresource — never via plain updates to the resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is a high-level summary of where the Task is in its lifecycle.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions are detailed status reports using the standard metav1.Condition shape (Type, Status, Reason, Message, LastTransitionTime, ObservedGeneration).",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"observedGeneration": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedGeneration is the .metadata.generation last reconciled by a controller. Status updates must set this to track lag between user intent and observed state.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
